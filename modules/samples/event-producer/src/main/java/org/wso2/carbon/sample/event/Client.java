...
package org.wso2.carbon.sample.event;
...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<String, StreamDefinition> streamDefinitions = DataPublisherUtil.loadStreamDefinitions("resources/");
            ...
            publishEvents(dataPublisher, streamDefinition, filePath + File.separator + "events.csv", events, delay);
